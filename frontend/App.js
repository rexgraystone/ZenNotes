    ...
    <>
      ...
      <div className="container">
          ...
          updateSection && (
            <div className="new-container">
              <form onSubmit={handleUpdate}>
                ...
                <label htmlFor="title">Title: </label>
                <input type="text" id="title" name="title" onChange={handleUpdateOnChange}/>
                <label htmlFor="content">Content: </label>
                <input type="text" id="content" name="content" onChange={handleUpdateOnChange}/>
                <button className="btn">Submit</button>
              </form>
          </div>
          )
        ...
        <div className="table-container">
          ...
          : (
            <p style={{textAlign: "center", fontSize: "50px"}}>Please create a new note</p>
          )}
        </div>
      </div>
    </>
